...
Feature: Testing a Match REST API. Users should be able to retrieve matches from Mongo database.
  ...
  Scenario Outline: Get all matches
    ...
    Examples:
      | ExpectedMatches                                  |
      | "samples/retrieve_scenario/get_all_matches.json" |
  ...
  Scenario Outline: Get all matches ordered by start time
    ...
    Examples:
      | ExpectedMatches                                            |
      | "samples/retrieve_scenario/get_matches_by_start_time.json" |
  ...
  Scenario Outline: Get all matches ordered by round time
    ...
    Examples:
      | ExpectedMatches                                            |
      | "samples/retrieve_scenario/get_matches_by_round_time.json" |
  ...
  Scenario Outline: Find match by id
    ...
    Examples:
      | Id | ExpectedMatch                                      |
      | 1  | "samples/retrieve_scenario/get_match_by_id_1.json" |
      | 2  | "samples/retrieve_scenario/get_match_by_id_2.json" |
      | 6  | "samples/retrieve_scenario/get_match_by_id_6.json" |
